        ...
        'remaindersChart': () => {
            ...
            initializedCharts['remaindersChart'] = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: window.i18n.remaining_qty,
                        data: remaindersData.data,
                        // Возвращаем разные цвета, т.к. для вертикальных столбцов это выглядит хорошо
                        backgroundColor: [
                            'rgba(54, 162, 235, 0.7)',
                            'rgba(255, 99, 132, 0.7)',
                            'rgba(75, 192, 192, 0.7)',
                ...
                options: {
                    // indexAxis: 'y' убран, по умолчанию диаграмма вертикальная
                    responsive: true,
